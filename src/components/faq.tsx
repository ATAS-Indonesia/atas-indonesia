    ...
    <>
      <li className="faq-item">
        <h3>
          ...
          <span
            id={"btn-" + props.id}
            className={"faqBtn-item is-" + props.btnDisplay}
            onClick={() => openFaq(props.id)}
          ></span>
        </h3>
  ...
  return (
    <>
      <div className="topside-faq">
        ...
        <p>
          Kumpulan daftar pertanyaan beserta jawaban yang sering dipertanyakan
          tentang ATAS Indonesia.
        </p>
      </div>
      <div className="bottomside-faq">
        <div className="faq-box">
          <h2>
            Kamu bertanya, ATAS menjawab!{" "}
            <img
              src="/images/man-raising-hand.svg"
              alt="emoji"
              className="faq-emoji"
            />
          </h2>
          <ul className="faq-item-box">
            <FaqItem
              ...
              answer="Ini adalah jawaban untuk pertanyaan nomor 1"
            />
            <FaqItem
              id="2"
              btnDisplay="plus"
              ...
              answer="Ini adalah jawaban untuk pertanyaan nomor 2"
            />
            <FaqItem
              id="3"
              btnDisplay="plus"
              ...
              answer="Ini adalah jawaban untuk pertanyaan nomor 3"
            />
          </ul>
        </div>
      </div>
